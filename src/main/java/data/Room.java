...
public class Room implements Comparable<String> {
	 ...
	 */
	public Room(String nameOfRoom, User admin) {
	...
	public boolean addUser(User user) {
	    //TODO : eklenen userın room listesinde room gözüküyor mu kontrol et!
		if (userAVLTree.contains(user))
			return false;
		userAVLTree.add(user);
		user.addRoom(this);
		return true;
	}
	...
	public boolean addAssignment(Date date, Assignment assignment) {
	    //TODO : assignment hem usera hem rooma eklenmeli
	...
	public boolean removeAdmin(User target) {
	    //TODO : remove işlemini yaparn admin mi kontrol edilmeli!
	...
	public void updateAllUsers() {
	    //TODO : methodun kullanılması gereken yerlerin kararını ver ve ekle
